				...
				<div class='content-body'>
					<div class='form-holder' style='margin-top: 50px;'>
						...
						if(isset($_POST['p-name'])){
							...
							Patient::add($name, $location, $age, $gender, $phone, $dateOfBirth, $diagnosis, $resep, User::getToken(), $patientNumber, $condition); 
						}
						...
						$form->textarea("resep", "p-resep", "$resep");
						$form->select("Gender", "gender", "$gender", array("Male", "Female", "Other") );
						$form->select("Condition", "condition", "$condition", array("Inpatientz", "Outpatient") );
