...
class Patient{
	public static function add($name, $location, $age, $gender, $phone, $dateOfBirth, $diagnosis, $resep, $doctor, $number, $condition){
		
		
		if($name == "" || $location == "" || $age == "" || $gender == "" || $phone == "" || $dateOfBirth == "" || $diagnosis == "" || $resep == "" || $condition == ""){
		...
		Db::insert("patients", 
				array("name", "location", "age", "gender", "phone", "dateOfBirth", "cTime", "diagnosis", "resep", "token", "doctor", "number", "pcondition"), 
				array($name, $location, $correctAge, $gender, $phone, $correctDateOfBirth, $time, $diagnosis, $resep, $patientToken, $doctor, $number, $condition )
		); 
		...
		echo "
			...
			<div class='print-data'>
				<div class='form-holder' style='background:#fff;'>
					...
					<div class='row'>
						<div class='col-md-7'>Gunadarma Hospital</div>
						<div class='col-md-5'>
	...
	public static function getPatientData($patient){
		...
		$heading = array("Name", "Location", "Age", "Phone", "Date of Birth", "Served On:", "Diagnosis", "resep", "Served By", "Print");
		$body = array();
	    ...
	    while($data = Db::assoc($query)){
			...
			Table::body(array($name, $location, $age, $phone, $dateOfBirth, $date, $diagnosis, $resep, $servedBy, "<a href='print.php?patient=$token'>Print & Download</a>"));
			//array_push($body, ); 
